...
CREATE TABLE Employee(Emp_ID INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
			    Emp_Name varchar(30),
			    Emp_Address varchar(50),
			    Emp_Email varchar(40),
			    Emp_Num INT);

CREATE TABLE Rooms(Room_Num INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
			 Floor_Num INT,
		       Room_Description varchar(100) NOT NULL);


CREATE TABLE Customer(Cust_ID INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
			    Cust_Name varchar(30),
			    Cust_Address varchar(50),
			    Cust_Email varchar(40),
			    Cust_Num INT);

CREATE TABLE Booking(Booking_ID INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
